...
|---|---|---|
| [#113](https://github.com/evochora/evochora/issues/113) | IN REFINEMENT | H2 reader pool ends with zero connections after a burst of slow reads and never recovers; every database-backed endpoint stays dead until restart (took the public demo down twice) |
