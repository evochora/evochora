...
class PopulationMetricsPluginTest {
    ...
    void testExtractRows_SingleTick_ReturnsCorrectValues() {
        // Setup: 2 organisms, 10 total created, each with 500 energy and 100 entropy
        ...
        assertThat(row[3]).isEqualTo(100.0); // avg_entropy
    }
    ...
    void testExtractRows_NoOrganisms_ReturnsZeroAverages() {
        ...
        assertThat(row[3]).isEqualTo(0.0);  // avg_entropy (no organisms)
    }
    
    @Test
    void testExtractRows_CalculatesAverages() {
        ...
        assertThat(rows).hasSize(1);
        assertThat(rows.get(0)[2]).isEqualTo(200.0); // avg_energy: (100+200+300)/3
        assertThat(rows.get(0)[3]).isEqualTo(20.0);  // avg_entropy: (10+20+30)/3
    }
