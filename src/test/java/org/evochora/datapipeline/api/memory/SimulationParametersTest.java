...
class SimulationParametersTest {
    ...
    // ========================================================================
    // ticksPerChunk Calculations
    // ========================================================================
    
    @Test
    void ticksPerChunk_withDefaults_returns100() {
        SimulationParameters params = SimulationParameters.of(new int[]{100, 100}, 1000);
        
        // 1 * 5 * 20 * 1 = 100
        assertEquals(100, params.ticksPerChunk());
    }
    
    @Test
    void ticksPerChunk_withCustomValues_calculatesCorrectly() {
        SimulationParameters params = SimulationParameters.of(
            new int[]{100, 100}, 1000,
            2, 10, 50, 2, 0.01
        );
        ...
        // 2 * 10 * 50 * 2 = 2000
        assertEquals(2000, params.ticksPerChunk());
    }
    ...
    @Test
    void deltaBreakdown_sumsToTicksPerChunk() {
        SimulationParameters params = SimulationParameters.of(
            new int[]{100, 100}, 1000,
            1, 5, 20, 2, 0.01
        );
        ...
        assertEquals(params.ticksPerChunk(), total);
    }
    ...
    void estimateBytesPerChunk_reasonableSize() {
        ...
        // Chunk should be larger than 1 snapshot (has 100 ticks)
    ...
    void estimateCompressionRatio_withDefaults_achievesGoodCompression() {
        ...
        // With 1% change rate and 100 ticks/chunk, expect significant compression
