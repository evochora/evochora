...
class RegisterAliasScopeTest {
    ...
    void twoProcsSameAliasName_independentResolution() {
        ...
        ProcedureNode procA = new ProcedureNode("PROC_A", false, List.of(), List.of(), List.of(),
                List.of(regA, instrA), SRC);
        ProcedureNode procB = new ProcedureNode("PROC_B", false, List.of(), List.of(), List.of(),
    ...
    void shadowingModuleLevelAlias() {
        ...
        ProcedureNode proc = new ProcedureNode("MY_PROC", false, List.of(), List.of(), List.of(),
