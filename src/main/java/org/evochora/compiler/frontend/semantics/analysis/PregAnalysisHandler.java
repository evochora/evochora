...
public class PregAnalysisHandler implements IAnalysisHandler {
     ...
     */
    private boolean isValidProcedureRegister(org.evochora.compiler.model.token.Token targetRegister) {
     ...
     */
    private boolean isValidAliasName(org.evochora.compiler.model.token.Token alias) {
