...
public final class OpcodeId {
     ...
     *
     * @param family the instruction family (0-15)
     * @param operation the operation within the family (0-31)
     * @param variant the variant of the operation (0-31)
     ...
     * @return the family component (0-15)
     */
     ...
     *
     * @param opcodeId the opcode ID to decompose
     * @return the operation component (0-31)
     */
